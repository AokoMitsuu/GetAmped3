...
/*  437 */     if (!set.specialrankenabled || (this.info.specialrank != 0 && set.enabledRankEquip() && !this.items.isEquipableRank(this.info.specialrank, this.info.isGM())))
...
/*      */   }
/*      */   
/*      */   public ArrayList processTalkResult(TalkResult r, MyRoomData mrd, UserTalkFlags oldflags) throws AmpedException {
...
/*  620 */     if (r.getmoney != 0 || r.lostitems != null || r.getitems != null || r.tredetitems != null || r.tutorialmyroomidx >= 0) {
...
/*  654 */           if (!list.disabletioverlap || !ui.hasExpireTime(item.kind, item.id) || ui.isExpired(item.kind, item.id))
...
/*  741 */           Object[] reward = set.getChallenge((crec[l]).id).getReward(score[l].intValue(), this.challenge.getRecord((crec[l]).id));
...
/*      */                         } 
/*  859 */                         if (k == use.size())
/*  859 */                           use.add(new UserItems.Item(add.kind, add.id, add.num, 0, 0L, 0)); 
/*      */                       } 
/*      */                     }   
/*      */               } 
/*      */             } 
...
/*  987 */           System.out.println("UserData isEventTreasure failed. userid:" + this.userid + " eventid:" + r.eventid + " userrank:" + ((set.rank != null) ? set.rank.rankIndexOf(this.info.score) : -1) + " eventrank:" + set.getEventRank(r.eventid));
/*      */         } else {
...
/*      */           bval = getBoostBonus(KotoriUtil.argi(ei.arg, 1), this.talkflags.getValue(bkey), KotoriUtil.argi(ei.arg, 2), getBoostTime(i.id));
...
/*      */           } else {
/*      */             tval = getBoostTargetTime(time, this.talkflags.getValue(tkey), KotoriUtil.argi(ei.arg, 0), 0);
/*      */           } 
/*      */         } else {
...
/* Location:              C:\Users\Nekosea\Desktop\ga2class\tw\classes\!\ga2\data\UserData.class
