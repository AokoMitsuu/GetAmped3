...
public class LookAndFeel {
    ...
    static {
        /* 20 */ if ((GameSetting.getSetting()).usewidescreen) {
            ...
            /* 22 */ sizedim = new Vector2D[] { new Vector2D(800.0F, 600.0F), new Vector2D(1920.0F, 1080.0F),
                    new Vector2D(2560.0F, 1440.0F) };
        } else {

            /* 25 */ sizename = new String[] { "svga", "xga" };
            /* 26 */ sizedim = new Vector2D[] { new Vector2D(800.0F, 600.0F), new Vector2D(1024.0F, 768.0F) };
        }
    }
